...
import dada.com.response.ReAddOrderResponse;

public class ReAddOrderRequest extends Request<ReAddOrderResponse> {
    ...
    @Override
    public Class<ReAddOrderResponse> getResponseClass() {
        return ReAddOrderResponse.class;
    }
}
