...
import dada.com.response.GetOrderPriceResponse;

public class GetOrderPriceRequest extends Request<GetOrderPriceResponse> {
    ...
    @Override
    public Class<GetOrderPriceResponse> getResponseClass() {
        return GetOrderPriceResponse.class;
    }
}
