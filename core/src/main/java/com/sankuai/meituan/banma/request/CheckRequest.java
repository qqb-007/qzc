...
import com.sankuai.meituan.banma.response.CheckResponse;

/**
 * Created by gw on 2018/1/26.
 */
public class CheckRequest extends AbstractRequest<CheckResponse> {
	/**
	...
	@Override
	public Class<CheckResponse> getResponseType() {
