...
public class PreCreateByShopRequest extends AbstractRequest<PreCreateByShopResponse> {
    ...
    public String getEndpoint() {
        return "/order/preCreateByShop";
    }

    @Override
    public Class<PreCreateByShopResponse> getResponseType() {
        return PreCreateByShopResponse.class;
    }
}
