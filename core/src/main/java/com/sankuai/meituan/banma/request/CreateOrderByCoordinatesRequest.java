...
import com.sankuai.meituan.banma.response.CreateOrderByCoordinatesResponse;
 ...
 * 创建订单（门店方式）参数
 */
public class CreateOrderByCoordinatesRequest extends AbstractRequest<CreateOrderByCoordinatesResponse> {
    ...
    @Override
    public Class<CreateOrderByCoordinatesResponse> getResponseType() {
        return CreateOrderByCoordinatesResponse.class;
    }
}
