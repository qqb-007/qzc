...
public class OrderExtraParam {
    ...
    private GiftDetilParam act_extend_msg;

    public GiftDetilParam getAct_extend_msg() {
        return act_extend_msg;
    }

    public void setAct_extend_msg(GiftDetilParam act_extend_msg) {
        this.act_extend_msg = act_extend_msg;
    }
